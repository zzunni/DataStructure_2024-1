...
class SparseMatrix:
  ...
  def multiply(cls, a, b):
    if a.n != b.m: #행렬 곱셈이 불가능한 경우.
      ...
      # new_A = [[0] * (a.n + 1) for _ in range(a.m + 1)]
      # new_B = [[0] * (b.n + 1) for _ in range(b.m + 1)]
      #
      # for i in range(a.s[0][2] + 1):
      #   new_A[a.s[i][0]][a.s[i][1]] = a.s[i][2]
      #
      # for i in range(b.s[0][2] + 1):
      #   new_B[b.s[i][0]][b.s[i][1]] = b.s[i][2]
